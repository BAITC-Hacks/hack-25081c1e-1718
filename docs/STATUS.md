...
- Current: Tariflow UI9d748c7 принят Димой; favicon опубликован38c673a. По запросу пользователя удалены служебные подписи внизу навигации и префикс шапки; текущий раздел виден на всех ширинах. Все5разделов при375/768/1440 проверены, переполнения нет. Подтянут b0975ab с необязательной диагностикой; кандидаты/данные не менялись.
